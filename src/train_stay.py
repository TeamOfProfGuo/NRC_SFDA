...
class Trainer(object):
    ...
    def train(self):
        ...
        for epoch in range(((self.args.max_epochs-self.args.init_sudolabel_ep)//stay_iter)+self.args.init_sudolabel_ep+1):
            ...
            if epoch < self.args.init_sudolabel_ep:
                ...
                for stay in range(stay_iter):
                    self.finetune_one_epoch((epoch-self.args.init_sudolabel_ep)*stay_iter + stay + self.args.init_sudolabel_ep)
