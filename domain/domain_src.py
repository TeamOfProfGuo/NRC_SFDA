...
from dataset.domain_data import domain_load


def train_source(args, log):
    dset_loaders = domain_load(args)
    ...
    for epoch in range(args.max_epoch):
        ...
        log('Source: {}, Iter:{}/{}; Src Acc = {:.2f}%, Tar Acc = {:.2f}%'.format(args.dset, epoch + 1, args.max_epoch,
                                                                                  acc_s * 100, acc_t * 100))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dset', type=str, default='c2r')
    ...
    args.output_dir = osp.join('result/domain/source', 'seed' + str(args.seed), task_s)
